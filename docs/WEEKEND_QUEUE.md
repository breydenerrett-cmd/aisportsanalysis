...
| W5 | P0 | Finalize prereg per review; adversarial prereg review; then register_family | W3 | Sonnet + Opus adversarial | FAILED_RETRYABLE → fix lane RUNNING (B1-B3, M1-M2) | review pass + register_family record | docs/PREREG_F5_FAMILIES.md, data/research/f5/ | – | – |
