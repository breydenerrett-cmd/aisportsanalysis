...
| W5 | P0 | Finalize prereg per review; adversarial prereg review; then register_family | W3 | Sonnet + Opus adversarial | VERIFYING (adversarial review running) | review pass + register_family record | docs/PREREG_F5_FAMILIES.md, data/research/f5/ | – | – |
