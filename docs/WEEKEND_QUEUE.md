...
| W5 | P0 | Finalize prereg per review; adversarial prereg review; then register_family | W3 | Sonnet + Opus adversarial | RUNNING (final spec drafting) | review pass + register_family record | docs/PREREG_F5_FAMILIES.md, data/research/f5/ | – | – |
| W6 | P0 | Build + PIT-validate F5 calibration evaluation path (standalone per review; items 1-6, A1 tie audit, A3 price hash) | W3 | Sonnet | RUNNING | tests incl. leakage fixture | src/research/f5_eval.py, tests/ | – | – |
