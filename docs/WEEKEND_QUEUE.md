...
| W9 | P1 | Totals feature-legitimacy audit: legit run-environment vs ML-pretending; methodology before search | W7 | Sonnet (+Opus review) | VERIFYING (Opus methodology review running) | audit table + methodology doc | docs/TOTALS_METHODOLOGY.md, docs/TOTALS_COVERAGE.md, scripts/totals_coverage_audit.py | 9b28c62 | – |
