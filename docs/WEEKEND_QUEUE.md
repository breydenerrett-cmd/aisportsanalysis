...
| W9 | P1 | Totals feature-legitimacy audit: legit run-environment vs ML-pretending; methodology before search | W7 | Sonnet (+Opus review) | FAILED_RETRYABLE → amendment lane RUNNING (NOT APPROVED: A1-A11, items 7-13) | audit table + methodology doc | docs/TOTALS_METHODOLOGY.md, docs/TOTALS_COVERAGE.md, scripts/totals_coverage_audit.py | 9b28c62 | – |
