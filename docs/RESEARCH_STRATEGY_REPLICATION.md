...
|---|---|
| SR1/SR2 — home underdog price band | **KILLED 2026-09-16, no edge, UNDERPOWERED_NULL.** Registered (frozen spec `docs/PREREG_SR1_HOME_UNDERDOG.md`, amendment 1, sha256 `07b5c9728e6efbf818e24196b7f565ca4c962f09770886c0c367635aa15e0a37`; rows 88-89 of `data/research/alpha_registry.jsonl`), backfilled, run, and independently reproduced end to end. Band A (`[100,150]`) died at the 2023 sign gate: n=528, effect −3.51pp, decision p 0.1105, union CI [−8.06, +0.58]pp — no 2024 look taken. Band B (`[151,250]`) died on the 2023→2024 sign flip: +7.77pp (n=138, p 0.2222) → −2.14pp (n=116, p 0.6216). BH q=0.10 over the family of two clears neither; the falsification battery correctly never ran. SR2/divisional NOT COMPUTED and may not now be computed. No edge is claimed in either direction: this sample can only rule out effects above about 6pp (band A) and 11–12pp (band B) against a +1pp floor, so the null is UNDERPOWERED_NULL and never "no effect exists". Discovery data, never evidence; nothing here may reach a customer surface. Verdicts recorded on both registry ids. See `docs/SR1_RESULT_2026-09-16.md`. |
